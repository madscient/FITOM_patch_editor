...
void to_json(nlohmann::json& j, const FmHwOp& v) {
    j = nlohmann::json{
        ...
        {"DT1", v.DT1}, {"DT2", v.DT2}, {"FXV", v.FXV}, {"AM", v.AM},
...
void to_json(nlohmann::json& j, const FmChipExt& v) {
    j = nlohmann::json{
        {"DM0", v.DM0}, {"ALG_EXT", v.ALG_EXT}, {"HWEP", v.HWEP},
...
void from_json(const nlohmann::json& j, HwPatch& v) {
    ...
    v.builtin.reset();
    v.hw = getOr<FmHwVoice>(j, "hw", FmHwVoice{});
